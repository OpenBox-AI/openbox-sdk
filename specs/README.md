...
- `core.yaml` - curated from `the-core-service` source

## Source of truth

The `api-ref/` submodule at the repo root pins the exact `the-backend-service`
...
- Hand-curated DTOs in `openbox-sdk/types` are easier to diff/review against a
