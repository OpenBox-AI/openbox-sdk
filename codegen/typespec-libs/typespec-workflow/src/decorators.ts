...
export function $providerCapabilities(
  ...
  for (const key of ['capabilityIds', 'providers', 'capabilities', 'goalSignalGuards', 'hitlCapabilityGuards', 'policyEvaluationGuards', 'eventCatalog', 'pluginComponents', 'publicIntegrations']) {
    if (!(key in record)) {
      reportDiagnostic(context.program, {
        code: 'invalid-provider-capabilities',
