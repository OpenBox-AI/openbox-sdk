...
//
// The base name says which component is calling (openbox-cli, openbox-mcp,
// openbox-extension, ...). The optional variant says who/what is driving it
 ...
 *
 * @param base    Component identifier - `'openbox-cli'`, `'openbox-mcp'`, etc.
