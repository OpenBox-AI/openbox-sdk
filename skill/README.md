...
A skill for any LLM tool that uses Claude's Skill format. Helps an
agent build and integrate with the [OpenBox AI governance
platform](https://openbox.ai). Loaded into the agent's working context
when the user mentions OpenBox or any of the trigger keywords in
`SKILL.md`.
