...
- `OpenBox-AI/openbox-sdk` → superseded by `openbox-sdk` root +
...
- `OpenBox-AI/runtime/mcp` → `openbox-sdk/runtime/mcp` + `openbox mcp serve` CLI.
- `OpenBox-AI/skill/` → bundled into `openbox-sdk` + `openbox skill install` CLI.
- `OpenBox-AI/apps/extension` → `openbox-sdk/apps/extension` (VS Code marketplace publish).
- `OpenBox-AI/openbox-sdk` → superseded by `openbox-sdk/client`.
