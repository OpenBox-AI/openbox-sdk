// Disk-backed key→record store shared by every runtime adapter. Each
// adapter persists its own `<adapter>/sessions/<sanitized-id>.json`
// under the user's config dir; only the path differs.
