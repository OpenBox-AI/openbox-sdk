...
export function verdictMetadata(
  ...
  return {
    ...
    governanceChecksIncomplete: verdict?.governanceChecksIncomplete,
...
export function mergedVerdictMetadata(
  ...
  return {
    ...
    governanceChecksIncomplete: verdict.governanceChecksIncomplete ?? result.governanceChecksIncomplete,
