...
//
// Ported from the legacy openbox-typescript-sdk. The input shape
// `GuardrailsVerdict` is the new spec-driven verdict envelope. The
// camelCase `inputType` and `redactedInput` replace the old
// snake_case fields.
