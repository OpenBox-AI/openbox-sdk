...
export const CLI_COMMAND_MANIFEST = [
  {
    "command": "auth",
    "description": "Manage the local X-API-Key store for backend auth.",
    "interfaceName": "Auth",
    "subcommands": [
      {
        "name": "setApiKey",
  ...
  {
    "command": "config",
    "description": "Persistent CLI config (URL overrides, default flags). Single global scope layered into process.env at startup; explicit shell exports always win. File: <data-root>/config (mode 0o600).",
