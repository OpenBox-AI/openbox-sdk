...
|---|---|---|---|
| Wire types | `specs/generated/openapi3/OpenboxBackend.json` (TypeSpec-emitted) | `ts/types/src/generated/backend.ts` (via `openapi-typescript`) | TypeScript: methods MUST type against `Backend.paths['/...']['<verb>']`. |
